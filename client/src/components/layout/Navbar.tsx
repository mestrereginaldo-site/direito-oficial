...
import { FaBalanceScale, FaBars, FaTimes, FaPhone, FaUserTie } from "react-icons/fa";
...
const navLinks: NavLink[] = [
  ...
  { name: "Consulta Jurídica", href: "/consulta-juridica", icon: <FaUserTie className="mr-1" /> },
];
    ...
    <header className="bg-white shadow-md sticky top-0 z-50">
      <div className="container mx-auto px-4 py-3 flex flex-col md:flex-row justify-between items-center">
        ...
        <nav className="flex flex-col md:flex-row items-center w-full md:w-auto">
          ...
          <div className={cn("w-full md:w-auto", isMenuOpen ? "block" : "hidden md:block")}>
            <SearchBar />
          </div>
        </nav>
      </div>
